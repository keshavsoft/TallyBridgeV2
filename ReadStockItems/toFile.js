...
const LocalFuncReadFromTally = async () => {
    try {
        // Read template file
        let template = fs.readFileSync("./Import/staticVariables.json", "utf8");
        ...
        fs.writeFileSync("./Data/fromTallyStockItems.json", JSON.stringify(LocalReponseData.data.collection));
